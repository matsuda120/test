...
<div class="fishingResults index large-11 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?= $this->Form->control('fishing_type_id', ['type' => 'datalistJs', 'label' => '釣種', 'options' => $fishingTypes, 'empty' => true]); ?>
        <?= $this->Form->control('userid', ['type' => 'datalistJs', 'label' => 'ユーザーID', 'options' => $users, 'empty' => true]); ?>
