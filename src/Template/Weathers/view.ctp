...
<div class="weathers view large-9 medium-8 columns content">
    <h3><?= h($weather->title) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($weather->fishing_results)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($weather->fishing_results as $fishingResults): ?>
            <tr>
